                ...
                <div class="header_offcanvas offcanvas offcanvas-end" id="menuOffcanvas">
                    ...
                    <nav class="header_nav">
                        <ul class="header_nav-list">
                            ...
                            <li class="header_nav-list_item">
                                <a class="nav-item" href="rooms.php" data-page="home">Rooms</a>
                               
                            </li>
                           <li class="header_nav-list_item">
                                <a class="nav-item" href="news.php" data-page="home">News</a>
                            </li>
                            <li class="header_nav-list_item">
                                <a class="nav-item" href="gallery.php" data-page="home">Gallery</a>
                            </li>
                          <li class="header_nav-list_item">
