            ...
            <section class="about_benefits section">
                <div class="container">
                    <div class="about_benefits-header d-md-flex align-items-center justify-content-between">
                        <h2 class="about_benefits-header_title" data-aos="fade-up">The main benefits to choose Hosteller</h2>
                    ...
                    <ul class="about_benefits-list d-md-flex">
                        <li class="about_benefits-list_item">
                            <span class="countNum number h1 d-flex align-items-center" data-suffix="+" data-value="240">0</span>
                            <p class="number-label">Consequat interdum varius sit amet mattis vulputate enim nulla</p>
                        </li>
                        <li class="about_benefits-list_item">
                            <span class="countNum number h1 d-flex align-items-center" data-suffix="+" data-value="60">0</span>
                            <p class="number-label">Consequat interdum varius sit amet mattis vulputate enim nulla</p>
                        </li>
                        <li class="about_benefits-list_item">
                            <span class="countNum number h1 d-flex align-items-center" data-suffix="%" data-value="98">0</span>
                            <p class="number-label">Consequat interdum varius sit amet mattis vulputate enim nulla</p>
                        </li>
                    </ul>
            ...
            <section class="about_rules section">
                <div class="container d-xl-flex justify-content-between align-items-center">
                    <div class="about_rules-main col-xl-5">
                        <h2 class="about_rules-main_header" data-aos="fade-right">Rule settlement, eviction and stay</h2>
                        <ul class="about_rules-main_list">
                            ...
                            <li class="list-item d-flex align-items-baseline important" data-aos="fade-up">
                                <i class="icon-check icon"></i>
                                Volutpat odio facilisis mauris sit amet massa vitae tortor condimentum. Quam elementum pulvinar etiam non
                                quam lacus suspendisse. Eget gravida cum sociis natoque
                            </li>
                        </ul>
                    </div>
            ...
            <section class="about_faq section">
                <div class="container">
                    <div class="about_faq-header d-lg-flex justify-content-between align-items-center">
                        <h2 class="about_faq-header_title">Frequently asked questions about hostel</h2>
                        <p class="about_faq-header_text">Diam phasellus vestibulum lorem sed risus ultricies tristique</p>
                    </div>
            ...
            <section class="about_footer section">
                <div class="container d-md-flex flex-wrap justify-content-between">
                        ...
                        <div class="main">
                            ...
                            <div class="main_author d-flex flex-column flex-md-row">
                                ...
                                <span class="profession h6" data-aos="fade-left" data-aos-delay="100"
                                    >Founder of the hostel “Hosteller”</span
                                >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="about_footer-block about_footer-block--subscribe d-lg-flex flex-column justify-content-between">
                        <h4 class="about_footer-block_header" data-aos="fade-left">Newsletter</h4>
                        ...
                        <form class="form d-flex" action="#" method="post" data-type="subscribe" data-aos="fade-left" data-aos-delay="100">
                            <input class="field required" type="text" data-type="email" placeholder="Email address" />
